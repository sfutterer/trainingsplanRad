...
const ICONS = {
  ...
  /* Der Testbereich: Ring, Scheibe und Mitte - dasselbe Zeichen, das die
     Einheitsart "Schwellentest" als Kennzeichen traegt, hier ohne das Rad.
     Im Drawer geht es um den Bereich und nicht um eine Fahrt. */
  test: 'M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20zm0 17a7 7 0 1 1 0-14 7 7 0 0 1 0 14zm0-10.5a3.5 3.5 0 1 0 0 7 3.5 3.5 0 0 0 0-7zm0 5a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3z',
