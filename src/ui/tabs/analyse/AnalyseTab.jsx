    ...
    <div class="card">
      ...
      {t.sprechtest.punkte.length > 0 && <>
        ...
        <p class="hint">
          ...
          Zonen, kein Leistungsmaß. Wo eine Notiz zum Wert steht, zeigt sie der angetippte
          Punkt – Knie, Schlaf oder Rad erklären einen Ausreißer, den die Kurve allein als
          Trend läse.
        </p>
      </>}
