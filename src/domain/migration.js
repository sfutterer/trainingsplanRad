...
const DOKU_3 = {
  ...
  tage: 'Die Wochentage unter ihrem Kuerzel: di, mi, do, sa, so. Montag und '
    ...
    + 'Ausfahrt, ihr Hoehenmeterband und die Z3-Bloecke darin. hoehenmeter ist ein '
    + 'Band { von, bis } in Hm fuer die Streckenwahl; bis 0 heisst flach. Fehlt das Feld, nennt die Karte keine '
